...
|---|----------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
|version| [![apt](https://img.shields.io/badge/apt-1.2.4-green)](https://repo1.maven.org/maven2/cn/therouter/apt/) | [![router](https://img.shields.io/badge/router-1.2.4-green)](https://repo1.maven.org/maven2/cn/therouter/router/) | [![plugin](https://img.shields.io/badge/plugin-1.2.4-green)](https://repo1.maven.org/maven2/cn/therouter/plugin/) |

```
// root build.gradle 
classpath 'cn.therouter:plugin:1.2.4'

// app module 
apply plugin: 'therouter'

// dependencies
kapt "cn.therouter:apt:1.2.4"

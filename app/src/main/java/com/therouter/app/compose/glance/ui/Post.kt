...
package com.therouter.app.compose.glance.ui
...
import com.therouter.app.compose.PathIndex.HORIZONTAL_POST
import com.therouter.app.compose.PathIndex.VERTICAL_POST
import com.therouter.app.R
import com.therouter.app.compose.glance.ui.theme.JetnewsGlanceTextStyles
...
private fun openPostDetails(context: Context, post: Post): Action {
    ...
    return actionStartActivity(TheRouter.build(HOME).withString("postId", post.id).createIntent(context))
}
...
fun Post(post: Post, bookmarks: Set<String>, onToggleBookmark: (String) -> Unit, modifier: GlanceModifier, postLayout: PostLayout) {
    when (postLayout) {
        ...
        PostLayout.HORIZONTAL_SMALL -> TheRouter.build(HORIZONTAL_POST)
            ...
            .withObject("onToggleBookmark", onToggleBookmark)
